...
returns HTTP 200. Its exact response is JSON text following a `#GEvent` comment inside
...
The long-range field can report the same tag repeatedly while one vehicle passes.
